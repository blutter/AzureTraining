...
namespace WAAD.POC.ProductCatalog.UWP.View
{
    ...
    public sealed partial class ViewProductPage 
    {
            ...
            :base(ViewModelType.ViewProduct)
        {
            ...
            btnAppBarShare.Click += Share_Click;
            btnHeaderShare.Click += Share_Click;
        }
        ...
        private void DataTransferManager_DataRequested(DataTransferManager sender, DataRequestedEventArgs args)
        {
            ...
            var vm = DataContext as ViewProductViewModel;
            request.Data.SetText(String.Format("Check out {0} (#Id{1}) #ContosoElectronics", 
                vm.ProductDetails.Name,
                vm.ProductDetails.Id));

            request.Data.Properties.Title = "Share this product to Twitter";
            request.Data.Properties.Description = "Please select the Twitter App in order say what you think about this product.";
        }
    }
}
